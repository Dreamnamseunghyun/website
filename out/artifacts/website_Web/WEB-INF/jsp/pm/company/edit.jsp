                                        ...
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                ...
                                                <div class="col-lg-box1 col-lg-box-vertical row">
                                                    ...
                                                    <div class="col-lg-7" id="companyCode" data-sitebuilder="dxTextBox"></div>
                                                    <div class="col-lg-3">
                                                ...
                                                <div class="col-lg-box1 col-lg-box-vertical row">
                                                    ...
                                                    <div class="col-lg-6"><div class="width-info-wrap"><div id="idPlaceHolder" data-sitebuilder="dxRadioGroup"></div></div></div>
...
<script>
    $(function () {
        ...
        <%--                method: 'DELETE',--%>
        <%--            }).then(function () {--%>
        <%--                sitebuilder.notify("??†ú?òÏóà?µÎãà??");--%>
        <%--                location.reload();--%>
        <%--            });--%>
        <%--        }--%>
        <%--    },--%>
        ...
        dxInstances.btnSave.option({
            ...
            onClick: function () {
                ...
                if (!data.companyName) {
                    alert('Í∏∞ÏóÖÏ≤¥Î™Ö???ÖÎ†•?òÏÑ∏??);
                    return;
                }
                if (!data.companyCode) {
                    alert('Í∏∞ÏóÖÏ≤¥ÏΩî?úÎ? ?ÖÎ†•?òÏÑ∏??);
                    return;
                }
                // if (data.check === '') {
                ...
                $.ajax({
                    ...
                    location.href = '<c:url value="/pm/company"/>'; // refresh Í∞Ä ÎßûÏ? ?äÏùÑÍπ?
                });
            }
        });
