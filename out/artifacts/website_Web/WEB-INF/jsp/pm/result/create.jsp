                                        ...
                                        <div class="col-box1 row">
                                            <div class="col-lg-12">
                                                <div class="col-lg-4 tag-name"><span
                                                        class="icon-area"></span><span>Î≥ëÏõêÎ™?/span></div>
                                                <div class="col-lg-8" id="hospitalId" data-sitebuilder="dxLookup"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row-box2" style="width:370px">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row">
                                            <div class="col-lg-12">
                                                <div class="col-lg-4 tag-name"><span
                                                        class="icon-area"></span><span>?Ä?ÅÎÖÑ??/span></div>
                                    ...
                                    <div class="row-box-inner">
                                        <div class="col-box1 row">
                                            <div class="col-lg-12" id="btnSampleDown" data-sitebuilder="dxButton"
                                                ...
                                                <i class="xi-file-download"></i>Excel ?òÌîå ?åÏùº Î∞õÍ∏∞
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        dxInstances.btnSave.option({
            ...
            onClick: function () {
                dxInstances.dataGridUnregisteredResult.getDataSource().store().load().done(function (gridData) {
                    ...
                    if (changes.length < 1) {
                        sitebuilder.notify("Î≥ÄÍ≤ΩÎêú ?¥Ïö©???ÜÏäµ?àÎã§.");
                        return;
                    } else {
                        sitebuilder.notify("?Ä??Ï§ëÏûÖ?àÎã§...");
                    }
                    ...
                    onClick: function (e) {
                        ...
                        dxInstances.popupReview.option({
                            ...
                            contentTemplate: function (contentElement) {
                                contentElement.append('<div style="font-weight: bold; color: #2ea3aa">Ï¢ÖÌï©?åÍ≤¨</div>');
                                if (e.row.data.review === null || e.row.data.review === '') {
                                    contentElement.append($("<div/>").dxTextArea({
                                        height: 500,
                                        value: 'Ï¢ÖÌï©?åÍ≤¨???ÜÏäµ?àÎã§.',
                                        readOnly: true,
                                    }));
                                } else {
                                    contentElement.append($("<div/>").dxTextArea({
