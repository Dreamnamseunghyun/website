                    ...
                    <div class="dx-viewport">
                        <div class="row-wrap row-wrap-box">
                            <div class="row-wrap logo-area-left">
                                <div class="row-box-title"><i class="xi-play-circle"></i>Í∏∞ÏóÖÏ≤¥Î≥Ñ Í≤∞Í≥º Í≤Ä??/div>
                                <div class="row-box">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>Í∏∞ÏóÖÏ≤?Í≤Ä??/span></div>
                                                    <div class="col-lg-4" id="lookupCompany"
                                                         data-sitebuilder="dxLookup"></div>
                                                    <div class="col-lg-2 tag-name"><span>?Ä?ÅÎÖÑ??/span></div>
                                                    <div class="col-lg-4" id="selectCompanyYear"
                                                         data-sitebuilder="dxSelectBox"></div>
                                                </div>
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>Í≤∞Í≥º ?±Î°ù??/span></div>
                                                    <div class="col-lg-5" id="companyCheckupDateBegin"
                                                         data-sitebuilder="dxDateBox"></div>
                                                    <div class="col-lg-5" id="companyCheckupDateEnd"
                                                         data-sitebuilder="dxDateBox"></div>
                                                </div>
                                            </div>
                            ...
                            <div class="row-wrap logo-area-right">
                                <div class="row-box-title"><i class="xi-play-circle"></i>Í≤∞Í≥º ?§Ïö¥Î°úÎìú</div>
                                <div class="row-box1">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row col-box-vertical2" style="border:none!important">
                                            <div class="col-lg-12 center-box button-box">
                                                <div id="btnCompanyResult" data-sitebuilder="dxButton" style="padding:15px 0">
                                                    Í∏∞ÏóÖÏ≤¥Î≥Ñ Í≤∞Í≥º ?§Ïö¥Î°úÎìú
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row-wrap">
                            <div id="dataGridCompanyResult" data-sitebuilder="dxDataGrid"></div>
                        </div>

                        <div class="row-wrap row-wrap-box">
                            <div class="row-wrap logo-area-left">
                                <div class="row-box-title"><i class="xi-play-circle"></i>Î≥ëÏõêÎ≥?Í≤∞Í≥º Í≤Ä??/div>
                                <div class="row-box">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>Î≥ëÏõê Í≤Ä??/span></div>
                                                    <div class="col-lg-4" id="lookupCenter"
                                                         data-sitebuilder="dxLookup"></div>
                                                    <div class="col-lg-2 tag-name"><span>?Ä?ÅÎÖÑ??/span></div>
                                                    <div class="col-lg-4" id="selectCenterYear"
                                                         data-sitebuilder="dxSelectBox"></div>
                                                </div>
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>Í≤∞Í≥º ?±Î°ù??/span></div>
                                                    <div class="col-lg-5" id="hospitalCheckupDateBegin"
                                                         data-sitebuilder="dxDateBox"></div>
                                                    <div class="col-lg-5" id="hospitalCheckupDateEnd"
                                                         data-sitebuilder="dxDateBox"></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row-wrap logo-area-right">
                                ...
                                <div class="row-box1">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row col-box-vertical2" style="border:none!important">
                                            <div class="col-lg-12 center-box button-box">
                                                <div id="btnHospitalResult" data-sitebuilder="dxButton" style="padding:15px 0">
                                                    Î≥ëÏõêÎ≥?Í≤∞Í≥º ?§Ïö¥Î°úÎìú
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row-wrap">
                            <div id="dataGridCenterResult" data-sitebuilder="dxDataGrid"></div>
                        </div>

                        <div class="row btn_area index_btn_area footer-btn">
                            <div class="col-lg-1" id="btnApply" data-sitebuilder="dxButton"></div>
                        </div>
                    </div>
                    <%--                    </div>--%>
                </div>
...
<script>
    $(function () {
        ...
        dxInstances.btnApply.option({
            text: 'Í≤∞Í≥º?±Î°ù',
            onClick: function () {
                location.href = '<c:url value="/pm/result/create"/>';
            },
        });
        ...
        dxInstances.selectCenterYear.option({
            dataSource: sitebuilder.typeDef.Year,
            value: new Date().getFullYear(),
            valueExpr: 'id',
            displayExpr: 'text',
        ...
        dxInstances.companyCheckupDateBegin.option({
            applyValueMode: 'instantly',
            displayFormat: 'yyyy-MM-dd',
            type: 'date',
            value: new Date().addYears(-1),
            onValueChanged: function (e) {
                dxInstances.resultDateEnd.option("min", e.value);
            }
        });

        dxInstances.companyCheckupDateEnd.option({
            applyValueMode: 'instantly',
            displayFormat: 'yyyy-MM-dd',
            type: 'date',
            onValueChanged: function (e) {
                dxInstances.resultDateBegin.option("max", e.value);
            }
        });

        dxInstances.hospitalCheckupDateBegin.option({
            applyValueMode: 'instantly',
            displayFormat: 'yyyy-MM-dd',
            type: 'date',
            value: new Date().addYears(-1),
        ...
        dxInstances.hospitalCheckupDateEnd.option({
            applyValueMode: 'instantly',
            displayFormat: 'yyyy-MM-dd',
            type: 'date',
            onValueChanged: function (e) {
        ...
        dxInstances.dataGridCompanyResult.option({
            groupPanel: {
                visible: false,
            },
            columns: [{
                ...
                //     // console.log(cellInfo.data.items[0].companyName)
                //     $('<span>')
                //         .text('Í∏∞ÏóÖÏ≤¥Î™Ö : ' + cellInfo.data.items[0].companyName)
                ...
                // }, {
                //     //Í±¥Ïàò
                //     dataField: 'checkupCount',
                //     caption: 'Í±¥Ïàò',
                //     alignment: 'center',
                //     visible: false,
            }, {
                //Í≤∞Í≥º ?±Î°ù??                dataField: 'registeredAt',
                caption: 'Í≤∞Í≥º ?±Î°ù??,
                alignment: 'center',
                dataType: 'date',
            }, {
                ...
                buttons: [{
                    ...
                    dataField: '',
                    onClick: function (e) {
                        if (e.row.data.checkupResultId) {
                            if (confirm('?ïÎßêÎ°???†ú?òÏãúÍ≤†Ïäµ?àÍπå?')) {
                                $.ajax({
                                    url: '<c:url value="/pm/result"/>/' + e.row.data.checkupResultId,
                                    method: 'DELETE',
                                }).then(function () {
                                    resultCompanyList();
                                    resultHospitalList();
                            ...
                            sitebuilder.notify("?±Î°ù??Í≤∞Í≥ºÍ∞Ä ?ÜÏäµ?àÎã§.");
                        }
                    },
                }]
            }],
            ...
            onToolbarPreparing: function (e) {
                ...
                e.toolbarOptions.items.unshift({
                    location: 'before',
                    text: 'Í∏∞ÏóÖÏ≤¥Î≥Ñ Í≤∞Í≥º?±Î°ù ?ÑÌô©',
                });
            },
            onRowPrepared: function (e) {
                if (e.rowType === 'data' && e.cells[1].value === undefined) {
                    dxInstances.dataGridCompanyResult.cellValue(e.rowIndex, 'turn', e.dataIndex + 1);
                    dxInstances.dataGridCompanyResult.refresh();
                }
                dxInstances.dataGridCompanyResult.saveEditData();
            },
        });
        ...
        dxInstances.dataGridCenterResult.option({
            dataSource: [],
            groupPanel: {
                visible: false,
            },
            ...
            onToolbarPreparing: function (e) {
                ...
                e.toolbarOptions.items.unshift({
                    location: 'before',
                    text: 'Î≥ëÏõêÎ≥?Í≤∞Í≥º?±Î°ù ?ÑÌô©',
                });
            },
            onRowPrepared: function (e) {
                if (e.rowType === 'data' && e.cells[1].value === undefined) {
                    dxInstances.dataGridCenterResult.cellValue(e.rowIndex, 'turn', e.dataIndex + 1);
                    dxInstances.dataGridCenterResult.refresh();
                }
                dxInstances.dataGridCenterResult.saveEditData();
            },
        });
        ...
        $.when($.ajax(ajaxCompanyList)).then(function (responseCompanyList) {
            // Company List
            responseCompanyList.data.unshift({companyId: null, companyName: '?ÑÏ≤¥'});
            dxInstances.lookupCompany.option({
        ...
        function exportExcelContractCheckupSample() {
            ...
            for (let idxItem in dsResultList) {
                ...
                let itemCode;
                let resultValue;
                for (let i = 0; i < dsResultList[idxItem].resultEmployees[0].resultItems.length; i++) {
                    itemCode = dsResultList[idxItem].resultEmployees[0].resultItems.map(function (v) {
                        return v.itemCode;
                    });
                    resultValue = dsResultList[idxItem].resultEmployees[0].resultItems.map(function (v) {
        ...
        let dsCompanyExcelList;

        function companyExcelLoad() {
            $.ajax({
                url: '<c:url value="/pm/resulte-companyexcel"/>',
                method: 'GET',
                data: {
                    companyId: dxInstances.lookupCompany.option('value'),
                    checkupYear: dxInstances.selectCompanyYear.option('value'),
                    resultDateBegin: dxInstances.companyCheckupDateBegin.option('value').toDateString(),
                    resultDateEnd: dxInstances.companyCheckupDateEnd.option('value').toDateString(),
                },
            }).then(function (response) {
                dsCompanyExcelList = response.data;
                dsResultList = dsCompanyExcelList;
                exportExcelContractCheckupSample();
            });
        }

        let dsHospitalExcelList;

        function hospitalExcelLoad() {
            $.ajax({
                url: '<c:url value="/pm/resulte-hospitalexcel"/>',
                method: 'GET',
                data: {
                    hospitalId: dxInstances.lookupCenter.option('value'),
                    checkupYear: dxInstances.selectCenterYear.option('value'),
                    resultDateBegin: dxInstances.hospitalCheckupDateBegin.option('value').toDateString(),
                    resultDateEnd: dxInstances.hospitalCheckupDateEnd.option('value').toDateString(),
                },
            }).then(function (response) {
                dsHospitalExcelList = response.data;
                dsResultList = dsHospitalExcelList;
                exportExcelContractCheckupSample();
            });
        }

        let dsResultCompanyList;

        function resultCompanyList() {
            $.ajax({
                url: '<c:url value="/pm/resultcompany"/>',
                method: 'GET',
                data: {
                    companyId: dxInstances.lookupCompany.option('value'),
                    checkupYear: dxInstances.selectCompanyYear.option('value'),
                ...
                for (let i = 0; i < response.data.length; i++) {
                    if (i === 6) {
                        ...
                        response.data[response.data.length] = response.data[6];
                        console.log('2', response.data.length)
                    }
                }
                dsResultCompanyList = response.data;
                console.log(dsResultCompanyList)
                dxInstances.dataGridCompanyResult.option({
                    dataSource: dsResultCompanyList,
                })
            });
        }

        let dsResultHospitalList;

        function resultHospitalList() {
            $.ajax({
                url: '<c:url value="/pm/resulthospital"/>',
                method: 'GET',
                data: {
                    hospitalId: dxInstances.lookupCenter.option('value'),
                    checkupYear: dxInstances.selectCenterYear.option('value'),
                ...
                dsResultHospitalList = response.data;

                dxInstances.dataGridCenterResult.option({
                    dataSource: dsResultHospitalList,
                })
            });
        }

        dxInstances.btnCompanyResult.option({
            onClick: function () {
                companyExcelLoad();
            },
        });

        dxInstances.btnHospitalResult.option({
            onClick: function () {
                hospitalExcelLoad();
            },
        });
