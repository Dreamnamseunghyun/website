            ...
            <div class="container">
                <div class="selection_wrap">
                    ...
                    <connection from=".checkup_bg_btn.carotid_artery .connection_circle"
                                to=".position_btn.carotid_artery"></connection> <!--Í≤ΩÎèôÎß?->
                    <connection from=".checkup_bg_btn.cervical_vertebrae .connection_circle"
                                to=".position_btn.cervical_vertebrae"></connection> <!--Í≤ΩÏ∂î-->
                    <connection from=".checkup_bg_btn.thyroid_gland .connection_circle"
                                to=".position_btn.thyroid_gland"></connection> <!--Í∞ëÏÉÅ??->
                    <connection from=".checkup_bg_btn.shoulder .connection_circle"
                                to=".position_btn.shoulder"></connection> <!--?¥Íπ®-->
                    ...
                    <connection from=".checkup_bg_btn.stomach .connection_circle"
                                to=".position_btn.stomach"></connection> <!--??->
<%--                    <connection from=".checkup_bg_btn.liver .connection_circle" to=".position_btn.liver"></connection>--%>
                    ...
                    <connection from=".checkup_bg_btn.abdomen .connection_circle"
                                to=".position_btn.abdomen"></connection> <!--Î≥µÎ?-->

<%--                    <connection from=".checkup_bg_btn.gall_bladder .connection_circle"--%>
<%--                                to=".position_btn.gall_bladder"></connection> <!--?¥ÎÇ≠-->--%>
...
<%--                    <!--?†Ïû•-->--%>
                    ...
                    <connection from=".checkup_bg_btn.large_intestine .connection_circle"
                                to=".position_btn.large_intestine"></connection> <!--?Ä??->
...
<%--                                to=".position_btn.pancreas"></connection> <!--Ï∑åÏû•-->--%>
                    ...
                    <connection from=".checkup_bg_btn.vertebrae_lumbales .connection_circle"
                                to=".position_btn.vertebrae_lumbales"></connection> <!--?îÏ∂î-->
...
<%--                                </div>--%>
                            ...
                            <div class="middle_area">
                                <img src="../img/us/checkup_selection/checkup_selection_bg_female.jpg" alt="?¨Ïûê">
...
<%--                                </div><!--Ï∑åÏû•-->--%>
                            ...
                            <div class="body_parts_btn right_area">
                                ...
                                <div class="checkup_bg_btn breast" data-body-parts="breast">
                                    <span class="connection_circle"></span>
                                    <div class="checkup_color_btn bg_red"></div>
                                    <div class="checkup_txt_btn">?†Î∞©</div>
                                ...
                                <div class="checkup_bg_btn uterus" data-body-parts="uterus">
                                    <span class="connection_circle"></span>
                                    <div class="checkup_color_btn bg_green"></div>
                                    <div class="checkup_txt_btn">?êÍ∂Å</div>
                        ...
                        <p class="noti">??Í≤ÄÏßÑÏùÑ ?êÌïò?úÎäî Î∂Ä?ÑÍ? Î≥¥Ïù¥ÏßÄ ?äÏùÑ Í≤ΩÏö∞ ?§Ïõå??Í≤Ä?âÎèÑ Í∞Ä?•Ìï©?àÎã§.</p>
                    </div>
                        ...
                        <div class="resert_area">
                            ...
                            <div class="select_option">
                                ...
                                <div class="option_list">
                                    ...
                                    <div class="list breast" data-body-parts="breast"></div><!--?†Î∞©-->
...
<%--                                    <div class="list liver" data-body-parts="liver"></div><!--Í∞?->--%>
                                    ...
                                    <div class="list uterus" data-body-parts="uterus"></div><!--?êÍ∂Å-->
...
<script>
    ...
    $("document").ready(function () {
        ...
        //?¨Ïû• ??
        //?†Î∞© ?úÏûë
        $(".select_option .breast .chk_boxArea:nth-child(1) input").val("?†Î∞©X-??Mammography)").data('itemId', 157);
        $(".select_option .breast .chk_boxArea:nth-child(1) .cbx-lbl").append("?†Î∞©X-??Mammography)");
        $(".select_option .breast .chk_boxArea:nth-child(2) input").val("?†Î∞©Ï¥àÏùå??BreastSono)").data('itemId', 184);
        $(".select_option .breast .chk_boxArea:nth-child(2) .cbx-lbl").append("?†Î∞©Ï¥àÏùå??BreastSono)");
        //?†Î∞© ??
        //???úÏûë
        ...
        //?Ä????
        //?êÍ∂Å ?úÏûë
        $(".select_option .uterus .chk_boxArea:nth-child(1) input").val("Í≥®Î∞ò(?¨ÏÑ±?òÎ≥µÎ∂Ä)Ï¥àÏùå??).data('itemId', 180);
        $(".select_option .uterus .chk_boxArea:nth-child(1) .cbx-lbl").append("Í≥®Î∞ò(?¨ÏÑ±?òÎ≥µÎ∂Ä)Ï¥àÏùå??);
        $(".select_option .uterus .chk_boxArea:nth-child(2) input").val("ÏßàÏ¥à?åÌåå(VaginalSono)").data('itemId', 181);
        $(".select_option .uterus .chk_boxArea:nth-child(2) .cbx-lbl").append("ÏßàÏ¥à?åÌåå(VaginalSono)");
        $(".select_option .uterus .chk_boxArea:nth-child(3) input").val("?êÍ∂ÅÍ≤ΩÎ??îÍ???Papsmear)").data('itemId', 245);
        $(".select_option .uterus .chk_boxArea:nth-child(3) .cbx-lbl").append("?êÍ∂ÅÍ≤ΩÎ??îÍ???Papsmear)");
        $(".select_option .uterus .chk_boxArea:nth-child(4) input").val("?∏Ïú†?êÏ¢ÖÎ∞îÏù¥?¨Ïä§Í≤Ä??HPV)").data('itemId', 247);
        $(".select_option .uterus .chk_boxArea:nth-child(4) .cbx-lbl").append("?∏Ïú†?êÏ¢ÖÎ∞îÏù¥?¨Ïä§Í≤Ä??HPV)");
        //?êÍ∂Å ??
        //Î¨¥Î¶é ?úÏûë
