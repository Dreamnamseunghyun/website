                    ...
                    <div class="dx-viewport">
                        ...
                        <div class="row-wrap">
                            <div class="row-box-title">
                                <i class="xi-play-circle"></i>?좏깮 寃吏??몃? ?뺣낫
...
<script>
    $(function () {
        ...
        function exportExcelContractCheckup() {
            ...
            worksheet.getCell('H1').value = '??ぉ 硫붾え';
            ...
            worksheet.getCell('I1').value = '異붽?寃??湲곗뾽泥??좎씤?섍?';
            ...
            worksheet.getCell('I2').value = '(?レ옄濡??쒖떆)';
            ...
            worksheet.getCell('K1').value = '?좏깮??ぉ';
            ...
            worksheet.getCell('L1').value = '媛쒖닔';
            ...
            worksheet.getCell('M1').value = '硫붾え';
            ...
            worksheet.getCell('K3').value = '?좏깮A';
            worksheet.getCell('K4').value = '?좏깮B';
            worksheet.getCell('K5').value = '?좏깮C';
            worksheet.getCell('K6').value = '?좏깮D';
            worksheet.getCell('K7').value = '?좏깮E';
            worksheet.getCell('K8').value = '?좏깮F';
