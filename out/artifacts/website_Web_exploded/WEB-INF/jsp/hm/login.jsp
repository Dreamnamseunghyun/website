...
<div class="login-wrapper ">
    ...
    <div class="login-container bg-white">
        <div class="login-loc p-l-50 p-r-50">
            ...
            <h4 class="m-t-30 m-b-0 color-gray2 mont">Hospital Manager LOGIN</h4>
            <h2 class="m-t-10 font-weight-bold">蹂묒썝留ㅻ땲? 濡쒓렇??/h2>
