...
public class StorageServiceImpl extends EgovAbstractServiceImpl implements StorageService {
    ...
    private static final String BUCKET_NAME_PROD = "sitebuilder";
    private static final String BUCKET_NAME_DEV = "sitebuilder-dev";
...
//        return environment.acceptsProfiles("prod") ? BUCKET_NAME_PROD : BUCKET_NAME_DEV;  // TODO: 異뷀썑 媛쒕컻, ?댁쁺 ?쒕쾭 遺꾨━?섎㈃ ?곸슜
