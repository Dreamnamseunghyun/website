...
<script>
    $(function () {
        ...
        function exportExcelContractCheckupSample() {
            ...
            worksheet.getCell('H1').value = '추가검사 기업체 할인수가';
            ...
            worksheet.getCell('H2').value = '(숫자로 표시)';
            ...
            worksheet.getCell('J1').value = '선택항목';
            ...
            worksheet.getCell('J3').value = '선택A';
            worksheet.getCell('J4').value = '선택B';
            worksheet.getCell('J5').value = '선택C';
            worksheet.getCell('J6').value = '선택D';
            worksheet.getCell('J7').value = '선택E';
            worksheet.getCell('J8').value = '선택F';
            ...
            reader.onloadend = function () {
                ...
                workbook.xlsx.load(arrayBuffer).then(function (workbook) {
                        ...
                        for (let rowNumber = 1; rowNumber <= rowCount; rowNumber++) {
                            ...
                            resultRow.discountBill = row.getCell(8).value;

                            excelDataSet.push(resultRow);
                        }

                        dxInstances.selectACount.option('value', sheet.getCell('K3').value);
                        dxInstances.selectBCount.option('value', sheet.getCell('K4').value);
                        dxInstances.selectCCount.option('value', sheet.getCell('K5').value);
                        dxInstances.selectDCount.option('value', sheet.getCell('K6').value);
                        dxInstances.selectECount.option('value', sheet.getCell('K7').value);
                        dxInstances.selectFCount.option('value', sheet.getCell('K8').value);

                        dxInstances.selectAMemo.option('value', sheet.getCell('L3').value);
                        dxInstances.selectBMemo.option('value', sheet.getCell('L4').value);
                        dxInstances.selectCMemo.option('value', sheet.getCell('L5').value);
                        dxInstances.selectDMemo.option('value', sheet.getCell('L6').value);
                        dxInstances.selectEMemo.option('value', sheet.getCell('L7').value);
                        dxInstances.selectFMemo.option('value', sheet.getCell('L8').value);
        ...
        let ajaxCheckupCreate = $.ajax({
            url: '<c:url value="/hm/contract-checkup/create"/>',
            method: 'GET',
            data: {
