                ...
                <div class="card card-transparent board_internal">
                    ...
                    <div class="dx-viewport">
                                        ...
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                ...
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>?덉빟?곹깭 ?쇨큵 泥섎━踰꾪듉</span></div>
                        ...
                        <div class="row btn_area footer-btn">
                            <div class="col-lg-1" id="btnSave" data-sitebuilder="dxButton"><i class="xi-save"></i>?덉빟?곹깭 ???/div>
                        </div>
                    </div>
                </div>
                <%--                    </div>--%>
...
<script>
    $(function () {
                    ...
                    for (let i = 0; i < confirmedAt.length; i++) {
                        if (confirmedAt[i] === null) {
                            dxInstances.btnCancelReserveList.option({
                                template: '?덉빟痍⑥냼??<span style="color: red;">NEW</span>',
                                onClick: function () {
        ...
        $.ajax({
            ...
            response.data.unshift({companyId: null, companyName: '?꾩껜'});
