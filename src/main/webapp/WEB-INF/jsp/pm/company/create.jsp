                    ...
                    <div class="dx-viewport">
                        ...
                        <div class="row-wrap row-wrap-box">
                            <div class="row-wrap logo-area-left">
                                <div class="row-box-title"><i class="xi-play-circle"></i>기업 기본 정보
                                        ...
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-box1 col-lg-box-vertical row">
                                                    <div class="col-lg-2 tag-name check"><span>기업체명</span></div>
                                                ...
                                                <div class="col-lg-box1 col-lg-box-vertical row">
                                                    <div class="col-lg-2 tag-name check"><span>기업코드</span></div>
                                                    <div class="col-lg-8" id="companyCode" data-ggsj="dxTextBox"></div>
                                                    <div class="col-lg-2" id="btnCompanySearch" data-ggsj="dxButton">
