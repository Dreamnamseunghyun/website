            ...
            <div class=" container-fluid  padding-30 sm-padding-10 container-fixed-lg bg-white">
                <div class="card card-transparent board_internal">
                    ...
                    <div class="dx-viewport">
                        ...
                        <!-- 센터 기본 정보 -->
                        <div class="row-wrap">
                            <div class="row-box-title"><i class="xi-play-circle"></i>센터 기본 정보
                                        ...
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-box1 col-lg-box-vertical row">
                                                ...
                                                <div class="col-lg-box2">
                                                    ...
                                                    <div class="col-lg-8"><div id="hospitalCode" data-ggsj="dxTextBox"></div></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-box1 col-lg-box-vertical row">
                                                ...
                                                <div class="col-lg-box2">
                                                    ...
                                                    <div class="col-lg-4"><div id="centerCode" data-ggsj="dxTextBox"></div></div>
                                ...
                                <div class="row-box-inner width-box">
                                    <div class="col-box1 col-box-vertical3 row">
                                        ...
                                        <div class="col-lg-11 row period">
                                            <div class="col-lg-12"><div id="notes" data-ggsj="dxTextArea"></div></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row-box-inner width-box">
                                    ...
                                    <div class="col-box1 col-box-vertical5 row">
                                        ...
                                        <div class="col-lg-11 row period">
                                            <div class="col-lg-12"><div id="advertisement" data-ggsj="dxTextArea"></div></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
