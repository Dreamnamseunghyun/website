                                        ...
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-box1 col-lg-box-vertical row">
                                                <div class="col-lg-box2">
                                                    ...
                                                    <div class="col-lg-5"><div id="hospitalName" data-ggsj="dxTextBox"></div></div>
                                            ...
                                            <div class="col-lg-box1 col-lg-box-vertical row">
                                                ...
                                                <div class="col-lg-box2">
                                                    ...
                                                    <div class="col-lg-8" id="centerCode" data-ggsj="dxTextBox"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-box1 col-lg-box-vertical row">
                                                <div class="col-lg-box2">
                                                    ...
                                                    <div class="col-lg-10"><div class="btnGray" id="btnZip" data-ggsj="dxButton"></div></div>
                                                </div>
                                                <div class="col-lg-box2">
                            ...
                            <div class="row-box1">
                                ...
                                <div class="row-box-inner width-box">
                                    <div class="col-box2 row">
                                        ...
                                        <div class="col-lg-10 row period">
                                            <div class="col-lg-3"><div id="ableCt" data-ggsj="dxCheckBox"></div></div>
                                            <div class="col-lg-3"><div id="ableMri" data-ggsj="dxCheckBox"></div></div>
                                            <div class="col-lg-3"><div id="ablePark" data-ggsj="dxCheckBox"></div></div>
                                            <div class="col-lg-3"><div id="ableSoup" data-ggsj="dxCheckBox"></div></div>
                                        </div>
                                    </div>
                                    <div class="col-box2 row">
                                        <div class="col-lg-2 tag-name"><span>세부사항</span></div>
                                        <div class="col-lg-10 row period">
                                            <div class="col-lg-4"><div id="ableSatur" data-ggsj="dxCheckBox"></div></div>
                                            <div class="col-lg-4"><div id="ableSpecial" data-ggsj="dxCheckBox"></div></div>
                                            <div class="col-lg-4"><div id="ableAm" data-ggsj="dxCheckBox"></div></div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(function () {
        ...
        dxInstances.centerName.option({
            placeholder: "센터가 없는 경우, 병원명으로 작성해주세요",
            readOnly: true
        });
            ...
            contentTemplate: function (contentElement) {
                return contentElement.append($('<div style="height: 75vh;"/>').dxDataGrid({
                    ...
                    onSaving: function (e) {
                        ...
                        // dxInstances.centerName.option({
                        //     value:e.changes[0].data.hospitalName + '(본점)',
                        // })
                        // dxInstances.centerCode.option({
                        //     value:e.changes[0].data.hospitalCode,
                        // })
