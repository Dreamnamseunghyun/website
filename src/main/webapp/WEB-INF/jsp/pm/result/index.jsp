                    ...
                    <div class="dx-viewport">
                        <div class="row-wrap row-wrap-box">
                            <div class="row-wrap logo-area-left">
                                <div class="row-box-title"><i class="xi-play-circle"></i>기업체별 결과 검색</div>
                                <div class="row-box">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>기업체 검색</span></div>
                                                ...
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>결과 등록일</span></div>
                            ...
                            <div class="row-wrap logo-area-right">
                                <div class="row-box-title"><i class="xi-play-circle"></i>결과 다운로드</div>
                                <div class="row-box1">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row col-box-vertical2" style="border:none!important">
                                            <div class="col-lg-12 center-box button-box">
                                                <div id="btnCompanyResult" data-ggsj="dxButton" style="padding:15px 0">
                                                    기업체별 결과 다운로드
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row-wrap">
                            <div id="dataGridCompanyResult" data-ggsj="dxDataGrid"></div>
                        </div>

                        <div class="row-wrap row-wrap-box">
                            <div class="row-wrap logo-area-left">
                                <div class="row-box-title"><i class="xi-play-circle"></i>병원별 결과 검색</div>
                                <div class="row-box">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row">
                                            <div class="col-lg-12 row">
                                                <div class="col-lg-box1 col-lg-box-vertical row margin-button">
                                                    <div class="col-lg-2 tag-name"><span>병원 검색</span></div>
                            ...
                            <div class="row-wrap logo-area-right">
                                ...
                                <div class="row-box1">
                                    <div class="row-box-inner1">
                                        <div class="col-box1 row col-box-vertical2" style="border:none!important">
                                            <div class="col-lg-12 center-box button-box">
                                                <div id="btnHospitalResult" data-ggsj="dxButton" style="padding:15px 0">
                                                    병원별 결과 다운로드
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row-wrap">
                            <div id="dataGridCenterResult" data-ggsj="dxDataGrid"></div>
                        </div>

                        <div class="row btn_area index_btn_area footer-btn">
                            <div class="col-lg-1" id="btnApply" data-ggsj="dxButton"></div>
                        </div>
                    </div>
                    <%--                    </div>--%>
                </div>
    ...
    $(function () {
        ...
        dxInstances.dataGridCompanyResult.option({
            ...
            columns: [{
                ...
                //     $('<span>')
                //         .text('기업체명 : ' + cellInfo.data.items[0].companyName)
        ...
        $.when($.ajax(ajaxCompanyList)).then(function (responseCompanyList) {
            // Company List
            responseCompanyList.data.unshift({companyId: null, companyName: '전체'});
            dxInstances.lookupCompany.option({
