        ...
        <div class="main_cont">
            ...
            <div class="container">
                ...
                <div class="selection_wrap">
                    <connection from=".checkup_bg_btn.brain .connection_circle" to=".position_btn.brain"></connection><!--뇌-->
                    <connection from=".checkup_bg_btn.carotid_artery .connection_circle" to=".position_btn.carotid_artery"></connection> <!--경동맥-->
                    <connection from=".checkup_bg_btn.cervical_vertebrae .connection_circle" to=".position_btn.cervical_vertebrae"></connection> <!--경추-->
                    <connection from=".checkup_bg_btn.thyroid_gland .connection_circle" to=".position_btn.thyroid_gland"></connection> <!--갑상선-->
                    <connection from=".checkup_bg_btn.shoulder .connection_circle" to=".position_btn.shoulder"></connection> <!--어깨-->
                    <connection from=".checkup_bg_btn.heart .connection_circle" to=".position_btn.heart"></connection> <!--심장-->
                    <connection from=".checkup_bg_btn.lung .connection_circle" to=".position_btn.lung"></connection> <!--폐-->
                    <connection from=".checkup_bg_btn.stomach .connection_circle" to=".position_btn.stomach"> </connection> <!--위-->
                    <%--                    <connection from=".checkup_bg_btn.liver .connection_circle" to=".position_btn.liver"></connection> <!--간-->--%>
                    <connection from=".checkup_bg_btn.abdomen .connection_circle" to=".position_btn.abdomen"></connection> <!--복부-->
                    <%--                    <connection from=".checkup_bg_btn.gall_bladder .connection_circle" to=".position_btn.gall_bladder"></connection> <!--담낭-->--%>
                    <connection from=".checkup_bg_btn.pelvis .connection_circle" to=".position_btn.pelvis"></connection> <!--골반-->
                    <%--                    <connection from=".checkup_bg_btn.kidney .connection_circle" to=".position_btn.kidney"></connection> <!--신장-->--%>
                    <connection from=".checkup_bg_btn.large_intestine .connection_circle" to=".position_btn.large_intestine"></connection> <!--대장-->
                    <%--                    <connection from=".checkup_bg_btn.spleen .connection_circle" to=".position_btn.spleen"></connection> <!--비장-->--%>
                    <connection from=".checkup_bg_btn.prostate_gland .connection_circle" to=".position_btn.prostate_gland"></connection> <!--전립선-->
                    <%--                    <connection from=".checkup_bg_btn.pancreas .connection_circle" to=".position_btn.pancreas"></connection> <!--췌장-->--%>
                    <connection from=".checkup_bg_btn.knee .connection_circle" to=".position_btn.knee"></connection> <!--무릎-->
                    <connection from=".checkup_bg_btn.vertebrae_lumbales .connection_circle" to=".position_btn.vertebrae_lumbales"></connection> <!--요추-->
                    ...
                    <div class="selection_area">
                        ...
                        <div class="img_wrap">
                            ...
                            <div class="middle_area">
                                <img src="../img/us/checkup_selection/checkup_selection_bg_male.jpg" alt="남자">
                            ...
                            <div class="body_parts_btn right_area">
                                ...
                                <div class="checkup_bg_btn prostate_gland" data-body-parts="prostate_gland">
                                    <span class="connection_circle"></span>
                                    <div class="checkup_color_btn bg_green"></div>
                                    <div class="checkup_txt_btn">전립선</div>
                        ...
                        <p class="noti">※ 검진을 원하시는 부위가 보이지 않을 경우 <br class="mo">키워드 검색도 가능합니다.</p>
                    </div>
                        ...
                        <div class="resert_area">
                            ...
                            <div class="select_option">
                                ...
                                <div class="option_list">
                                    ...
                                    <div class="list cervical_vertebrae" data-body-parts="cervical_vertebrae"></div><!--경추-->
                                    ...
                                    <div class="list prostate_gland" data-body-parts="prostate_gland"></div><!--전립선-->
                                    <%--                                    <div class="list pancreas" data-body-parts="pancreas"></div><!--췌장-->--%>
                                    <div class="list knee" data-body-parts="knee"></div><!--무릎-->
                                    <div class="list vertebrae_lumbales" data-body-parts="vertebrae_lumbales"></div><!--요추-->
                                </div>
                            </div>
...
<script>
    ...
    $("document").ready(function(){
        ...
        //전립선 시작
        $(".select_option .prostate_gland .chk_boxArea:nth-child(1) input").val("전립선(남성하복부)초음파").data('itemId', 178);
        $(".select_option .prostate_gland .chk_boxArea:nth-child(1) .cbx-lbl").append("전립선(남성하복부)초음파");
        $(".select_option .prostate_gland .chk_boxArea:nth-child(2) input").val("경직장(전립선)초음파").data('itemId', 179);
        $(".select_option .prostate_gland .chk_boxArea:nth-child(2) .cbx-lbl").append("경직장(전립선)초음파");
        //전립선 끝
