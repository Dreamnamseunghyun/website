...
<head>
    <meta charset="UTF-8">
    <title>Í±¥Í∞ï?¥Ïûê(?¨Ïö©?? Í≤ÄÏßÑÏòµ???†ÌÉù</title>
                    ...
                    <div class="col-md-3 btn_area">
                        <div class="btn retry_btn">
                            ...
                            <a class="btn_inner">
                                ...
                                <i class="xi-renew"></i> ??™©ÎπÑÍµê ?§Ïãú?òÍ∏∞
                    ...
                    <div class="table">
                        <div class="tbody">
                            <div class="tr hospital_select">
                                <div class="tr_wrap">
                                    <div class="left_area sub_title">Î≥ëÏõê?†ÌÉù</div>
                                    <div class="right_area">
                            ...
                            <div class="tr checkup_select">
                                <div class="tr_wrap">
                                    <div class="left_area sub_title">Í≤ÄÏßÑÏú†?ïÏÑ†??/div>
                                    <div class="right_area">
                                        <div class="td selectList">
                                            <div class="select_box_area">
                                                <div id="checkup1"></div>
                                    ...
                                    <c:choose>
                                        <c:when test="${checkupItemClass.itemClassCode == 'F'}">
                                            <div class="tr_wrap basicItemClassF">
                                                <div class="left_area item_name detail_view_btn select_item_name">?πÏàò?•ÎπÑ
                                                    Í≤Ä??                                                </div>
                                                <div class="right_area">
                                                    <div class="td"
                                            ...
                                            <div class="tr_wrap">
                                                ...
                                                <div class="right_area">
                                                    <div class="td checkupClass1 zero"
                                                         id="checkupClass1_<c:out value="${checkupItemClass.itemClassId}"/>">
                                                        <c:out value="${checkupItemClass.itemClassCode == 'A' ? 'ÎØ∏Ï†úÍ≥? : '0 Í∞?}"/>
                                                    </div>
                        ...
                        <div class="tbody">
                            <div class="tr selectA">
                                <div class="tr_wrap">
                                    ...
                                    <div class="right_area">
                                        <div class="td choice_num_area">?†ÌÉùÍ∞?àò<span
                            ...
                            <div class="tr selectA">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">?†ÌÉù<br>A</div>
                                    <div class="right_area">
                            ...
                            <div class="tr selectB">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">?†ÌÉù<br>B</div>
                                    <div class="right_area">
                            ...
                            <div class="tr selectC">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">?†ÌÉù<br>C</div>
                                    <div class="right_area">
                            ...
                            <div class="tr selectD">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">?†ÌÉù<br>D</div>
                                    <div class="right_area">
                            ...
                            <div class="tr selectE">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">?†ÌÉù<br>E</div>
                                    <div class="right_area">
                            ...
                            <div class="tr selectF">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">?†ÌÉù<br>F</div>
                                    <div class="right_area">
                            ...
                            <div class="tr selectADD">
                                <div class="tr_wrap">
                                    <div class="left_area item_name select_item_name">Ï∂îÍ?<br>Í≤Ä??/div>
                                    <div class="right_area">
...
<script>
    ...
    $('.reserve_btn_box .btn').on('click', function () {
        ...
        if (!centerId) { //Î≥ëÏõê?†ÌÉù
            Swal.fire('Î≥ëÏõê???†ÌÉù??Ï£ºÏÑ∏??', '', 'warning');
            return;
        }

        if (!checkupContractSubTypeId) { //Í≤ÄÏßÑÏú†???†ÌÉù
            Swal.fire('Í≤ÄÏßÑÏú†?ïÏùÑ ?†ÌÉù??Ï£ºÏÑ∏??', '', 'warning');
            return;
        }
    ...
    function setCheckupItemList(index, checkupContractSubTypeId) {
        $.ajax({
            ...
            $('.checkupClass' + index + '.zero').html(0 + ' Í∞?);
                        ...
                        v.checkupItemClasses.forEach(function (itemClass) {
                            if (itemClass.itemClassCode === 'F') {
                                ...
                                if (itemClass.itemClassCode === 'A') {
                                    $('#checkupClass' + index + '_' + itemClass.itemClassId).html(itemClass.itemCount ? '?úÍ≥µ' : 'ÎØ∏Ï†úÍ≥?);
                                } else {
                                    if (itemA !== true) {
                                        $('#checkupClass' + index + '_1').html('ÎØ∏Ï†úÍ≥?);
                                    }
                                    $('#checkupClass' + index + '_' + itemClass.itemClassId).html(itemClass.itemCount + ' Í∞?);
                                }
                                itemClass.checkupItemCategories.forEach(function (itemCategory) {
                                    itemCategory.checkupItems.forEach(function (item) {
            ...
            // ?πÏàò?•ÎπÑ Í≤Ä??            if ($('.basicItemClassF ul:empty').length === 3) {
                $('.basicItemClassF').hide();
            } else {
                $('.basicItemClassF').show();
            }

            // ?†ÌÉùÍ≤Ä??            if (!selectItem) {
                $('.select_item').hide();
            } else {
                ...
                // Ï∂îÍ?Í≤Ä??                if ($('.selectADD ul:empty').length === 3) {
                    $('.selectADD').hide();
                } else {
                    $('.selectADD').show();
                }
