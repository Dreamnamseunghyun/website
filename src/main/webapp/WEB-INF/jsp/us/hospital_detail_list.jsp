    ...
    <section class="main_section">
        <div class="main_cont">
            ...
            <div class="container">
                ...
                <div class="supportList kmi_gn"> <!--클래스명으로 각 병원 지원 리스트 조정-->
                    <ul>
                        ...
                        <c:if test="${center.ableSoup}">
                            <li class="list meal">식사제공</li>
                        </c:if>
                        <c:if test="${center.ablePark}">
                            <li class="list parking">주차가능</li>
                        </c:if>
                        <c:if test="${center.ableSatur}">
                            <li class="list sat">토요검진</li>
                        </c:if>
                        <c:if test="${center.ableSpecial}">
                            <li class="list special">특수검진</li>
                        </c:if>
                        <c:if test="${center.ableAm}">
                            <li class="list am">오전검진</li>
                        </c:if>
                    </ul>
                </div>
...
<script>
    ...
    // TODO: css 에 적용된 기본 지도 이미지 삭제해야 함
    var container = document.getElementById('map');
    var map = new kakao.maps.Map(container, {
        center: new kakao.maps.LatLng(33.450701, 126.570667),  // 기본 주소 카카오본사
    });
...
<script>
    ...
    //input이 아닌데 폰넘버가 보여지는 화면이 있을 경우
